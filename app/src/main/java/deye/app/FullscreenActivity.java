...
import deye.app.util.SystemUiHider;
...
public class FullscreenActivity extends Activity {
    ...
    public void onButton2Click(View s){
        ...
        n2 = Integer.parseInt(e2.getText().toString());
        difference = n - n2;
        t.setText(Integer.toString(difference));
    }

    public void onButton3Click(View m){
        ...
        n2 = Integer.parseInt(e2.getText().toString());
        multiply = n * n2;
        t.setText(Integer.toString(multiply));
    }
